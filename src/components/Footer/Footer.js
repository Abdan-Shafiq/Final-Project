          ...
          <div className="col-md-9">
            <div className="row">
              <div className="col-md-4 mb-4">
                <h5>About Us</h5>
                <p>
                  We are providing of All Facilities and
                  Good Food, offering top-quality Food and exceptional
                  customer service.
                </p>
              </div>
              <div className="col-md-4 mb-4">
              ...
              <div className="col-md-4 mb-4">
                ...
                <p><PhoneOutlined /> +92 3336049877</p>
                <p><MailOutlined /> theytstore123@gmail.com</p>
              </div>
            </div>
            <div className="row">
            ...
            <div className="row">
              <div className="col-md-12 text-center mt-3">
                <p>
                  ...
                  <a className="text-success" href="#">Abdan</a>.
                  All rights reserved.
                </p>
              </div>
            </div>
